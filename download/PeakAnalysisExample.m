...
% the peaks are very close to each other. The |MinPeakProminence| property
% can be used filter out these peaks. Consider peaks that drop off on both
% sides by at least 40 relative sunspot numbers before encountering a
% larger value.
